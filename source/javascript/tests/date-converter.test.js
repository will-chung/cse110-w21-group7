...
describe ('Testing DateConverter', function() {
    ...
    describe("testing oldTimestampInSameWeek", function () {
        ...
        it("May 23 is not in the same week as May 26", () => {
            let may23 = new Date('May 23, 2021 15:35:30').getTime()
